...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
     ...
     * @param Smarty $smarty
     *            Smarty instance
     * @param null|\Smarty_Internal_Template|\Smarty|\Smarty_Internal_Data $_parent
     ...
     *            compile id or null
     * @param bool|int|null $_caching
     *            use caching?
     * @param int|null $_cache_lifetime
     *            cache life-time in
     *            seconds
    ...
    public function _decodeProperties(Smarty_Internal_Template $tpl, $properties, $cache = false)
    {
        ...
        if ($cache) {
            ...
            $resource->includes = isset($properties['mysmarty']) ? $properties['mysmarty'] : array();
        }
        if ($is_valid) {
