        ...
        if ($_output !== false) {
            ...
            if (strlen($tag) < 6 || substr($tag, -5) !== 'close') {
                ...
                foreach (array(
                    ...
                    if (isset($this->smarty->registered_plugins[$plugin_type][$tag])) {
                        ...
                        if ($plugin_type === Smarty::PLUGIN_COMPILER) {
                            ...
                            return call_user_func_array($this->smarty->registered_plugins[$plugin_type][$tag][0], array(
                                $new_args,
                                $this
                            ));
                        }
                ...
                if (is_callable($this->smarty->default_plugin_handler_func)) {
                    ...
                    if ($found) {
                        ...
                        if ($plugin_type === Smarty::PLUGIN_COMPILER) {
                            ...
                            return call_user_func_array($this->default_handler_plugins[$plugin_type][$tag][0], array(
                                $new_args,
                                $this
                            ));
                        } else {
                ...
                if (isset($this->smarty->registered_plugins[Smarty::PLUGIN_COMPILER][$tag])) {
                    ...
                    return call_user_func_array($this->smarty->registered_plugins[Smarty::PLUGIN_COMPILER][$tag][0], array(
                        $args,
                        $this
                    ));
                }
