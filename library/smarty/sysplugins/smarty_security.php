 ...
 * are immutable the cache is killed every time either of the variables change.
 * That means that two distinct
...
class Smarty_Security
{
    ...
    {
        $template->startRenderCallbacks[] = array(
            $this,
            'startTemplate'
        );
        $template->endRenderCallbacks[] = array(
            $this,
            'endTemplate'
        );
    }
