...
class Smarty_Internal_Templateparser
{
    ...
    {
        $this->current_buffer->append_subtree($this, $this->compiler->processText($this->yystack[$this->yyidx + 0]->minor));
    }
    ...
    public function yy_r14()
    {
        ...
        if ($this->yystack[$this->yyidx + 0]->minor[$j + 1] == 'c') {
            // {$smarty.block.child}
            $this->_retvalue = $this->compiler->compileTag('child', array(), array(
                $this->yystack[$this->yyidx + 0]->minor
            ));
        } else {
            // {$smarty.block.parent}
            $this->_retvalue = $this->compiler->compileTag('parent', array(), array(
                $this->yystack[$this->yyidx + 0]->minor
            ));
        }
    }
    ...
    {
        $this->_retvalue = $this->compiler->compileTag('private_print_expression', $this->yystack[$this->yyidx + 0]->minor[1], array(
    ...
    public function yy_r19()
    {
        $this->_retvalue = $this->compiler->compileTag('assign', array_merge(array(
            ...
            'smarty_internal_index' => $this->yystack[$this->yyidx + -1]->minor['smarty_internal_index']
        ));
    }
    ...
    public function yy_r27()
    {
        if (defined($this->yystack[$this->yyidx + -2]->minor)) {
            ...
            $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + -2]->minor, $this->yystack[$this->yyidx + 0]->minor, array(
                'modifierlist' => $this->yystack[$this->yyidx + -1]->minor
            ));
        }
    }
    ...
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + -4]->minor, $this->yystack[$this->yyidx + 0]->minor, array(
            'modifierlist' => $this->yystack[$this->yyidx + -1]->minor,
    ...
    {
        $this->_retvalue = $this->compiler->compileTag('make_nocache', array(
            array(
