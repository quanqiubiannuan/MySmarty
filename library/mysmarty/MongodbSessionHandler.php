...
class MongodbSessionHandler implements \SessionHandlerInterface
{
    ...
    {
        $this->database = config('session.session_type_params.mongodb.database');
        $this->table = config('session.session_type_params.mongodb.table');
        return true;
    }
    ...
    {
        $data = Mongodb::getInstance()->name($this->database)
            ->table($this->table)
